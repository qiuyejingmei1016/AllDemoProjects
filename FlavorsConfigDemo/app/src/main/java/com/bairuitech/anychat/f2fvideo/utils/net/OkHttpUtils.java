package com.bairuitech.anychat.f2fvideo.utils.net;
...
//        mHttpClient = new OkHttpClient();
    ...
    private void doRequest(final Request request, final BaseCallback baseCallback) {
        LogTools.e("===HTTP Requset===", request.toString());
        if (!EmptyUtils.isNullOrEmpty(request.toString())) {
            ...
            if ("POST".equals(method.toUpperCase())) {
                ...
                if (request.body() instanceof FormBody) {
                    ...
                    LogTools.e("===Request body===", sb.toString());
                } else {
                    LogTools.e("===Request body===", bodyToString(body));
                }
            }
        }
    ...
    private void callbackSuccess(final BaseCallback callback, final Object obj) {
        if (obj != null && !EmptyUtils.isNullOrEmpty(obj.toString())) {
            LogTools.e("===HTTP Response===", obj.toString());
        }
